# LOGISTICS INTELLIGENCE SYSTEM — v23
...
### Header
The v24 header gives the full **LOGISTICS INTELLIGENCE SYSTEM** title enough width to remain visible on desktop/laptop layouts and keeps the subtitle readable.
...
## v23 Consolidated Fix

v23 is based directly on the last uploaded application files. It does not rebuild
the application from an earlier generated package.

### Reports
The Reports tables now use a dedicated `.report-table-scroll` wrapper generated
by the report renderer itself. This isolates report scrolling from the old
`.scrollx` rules that caused repeated freeze/override conflicts.

Each report table has:
- a real vertical scroll viewport;
- horizontal scrolling when required;
- all generated rows retained;
- sticky green table header;
- visible scrollbar styling.

### Branding
The LIS header uses the full:
**LOGISTICS INTELLIGENCE SYSTEM**
with:
**Integrated Logistics, Route & Transport Network Management**

### Existing functionality retained
- Mappls routing and alternatives
- Location InfoWindow
- Distance Matrix
...
The Cloudflare Worker is not changed.

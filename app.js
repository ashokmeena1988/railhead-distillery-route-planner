...
function drawAllMapplsRoutes(routes,selectedIndex=0){
  ...
  (routes||[]).forEach((r,i)=>{
    ...
    const casing=new mappls.Polyline({
      ...
      strokeColor:'#ffffff',
      strokeOpacity:0.96,
      strokeWeight:selected?12:8,
      fitbounds:false,
      zIndex:selected?45:10+i
    });
    const layer=new mappls.Polyline({
      ...
      fitbounds:false,
      zIndex:selected?50:20+i
    });

    // Clicking any visible route selects it and refreshes the details without
    // removing the other alternatives.
    try{

...
function resetDepotReportControls(message='Select a depot and generate the distillery report.') {
  ...
  if(table)table.innerHTML='<div class="empty">Select a depot, choose direction, then click Generate Depot-wise Report.</div>';
...
$('reportDepot').onchange=()=>resetDepotReportControls('Depot changed. Click Generate Depot-wise Report to calculate the new distances.');
$('depotReportDirection').onchange=()=>resetDepotReportControls('Direction changed. Click Generate Depot-wise Report to recalculate the report.');
